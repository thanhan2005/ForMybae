...
const messages = [
    "Gửi đến người phụ nữ xinh đẹp nhất quả đất :3.",
    "Vào ngày đặc biệt này, anh có vài lời chúc muốn gửi gắm tới bạn nhỏ.",
    "Điều đầu tiên anh chúc em có một ngày lễ trọn vẹn, đầy ý nghĩa với những kỉ niệm đẹp nhấttt.",
    "Đặc biệt là chúc em ngày càng xinh đẹp nè, giỏi giang nè và hơn nữa cuộc sống đong đầy hạnh phúc đều là của em hếttt.",
    "Dù ít khi gặp nhưng anh vẫn trân trọng từng khoảng khắc mà chúng ta chơi với nhau, vậy nên làaa.",
    "Chúc mừng Ngày phụ nữ nha bạn bé! Em xứng đáng được ôm hết những hạnh phúc trên thế giới xinh đẹp nàyy ♥️"
];
